...
unsigned long colorY = 0xFEE619;   // start with pale yellow
unsigned long colorO = 0xFF4A00;   // start with pale yellow
...
void loop() {
   ...
   strip.setPixelColor(0, colorY);// set the color for this pixel
   strip.setPixelColor(1, colorO);// set the color for this pixel

// loop over all the pixels: //turning led on one by one
